...
app.use("/products", productRouter) //las peticiones a product disparan el modulo PRODUCT ROUTER/quite el authMiddleware anes de productRouter para poder consumir la API sin pedidos de usuario
